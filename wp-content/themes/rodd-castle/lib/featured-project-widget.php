 ...
 * @package Genesis\Widgets
 */
class RC_Featured_Project extends WP_Widget {
	...
	function __construct() {
		...
		$widget_ops = array(
			...
			'description' => __( 'Displays featured projects', 'genesis' ),
		);
		...
		parent::__construct( 'featured-post', __( 'Featured Projects', 'genesis' ), $widget_ops, $control_ops );
	...
	function widget( $args, $instance ) {
		...
		if ( have_posts() ) : while ( have_posts() ) : the_post();
			...
			if ( $instance['show_image'] && $image )
				printf( '<div title="%s" class="%s">%s</div>', the_title_attribute( 'echo=0' ), esc_attr( $instance['image_alignment'] ), $image.'<a href="'.get_permalink().'" class="expand-container" rel="ajax:modal" data-post_id="'.get_the_ID().'"><div class="expand">+</div></a>' );
